...
const Collection = () => {
  ...
  const applyFilter = () => {
    ...
    if (subCatogory.length > 0) {
      productsCopy = productsCopy.filter((item) =>
        subCatogory.includes(item.subCategory)
      );
      console.log(productsCopy, "dgdg");
    }
  ...
  useEffect(() => {
    applyFilter();
  }, [category, subCatogory,showSearch,search]);
  useEffect(() => {
    sortProduct();
  }, [sortType]);
    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        <p
          ...
          className="my-2 tetx-xl flex items-center cursor-pointer gap-2"
        >
          Filters
          <img
